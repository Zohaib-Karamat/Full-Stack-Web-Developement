...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If email confirmation is off, Supabase auto-logs the user in.
      // Since you want them to log in manually, we force a logout first.
            ...
            <form className="flex flex-col gap-10" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-4 mt-2">
                <button 
                  type="submit"
                  disabled={loading}
                  className="w-full bg-red-500 hover:bg-red-600 disabled:opacity-50 text-white text-base font-medium font-poppins py-4 rounded-sm transition-colors"
                >
