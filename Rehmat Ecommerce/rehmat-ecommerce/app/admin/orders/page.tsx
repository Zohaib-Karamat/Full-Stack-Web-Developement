  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm font-poppins text-gray-500">View and manage customer orders</p>
      </div>
                ...
                orders.map((order) => (
                  <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-center">
                      <Link href={`/admin/orders/${order.id}`} className="text-gray-400 hover:text-black inline-flex">
