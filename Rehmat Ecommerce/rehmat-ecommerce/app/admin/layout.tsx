      ...
      <aside className="w-64 bg-black text-white flex-shrink-0 hidden md:flex flex-col">
        <div className="h-16 flex items-center px-6 border-b border-gray-800">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="text-red-500 text-xs font-poppins font-semibold tracking-widest">
              ADMIN
            </span>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-gray-800">
          <Link
            href="/"
            className="flex items-center gap-3 px-4 py-3 rounded-md text-gray-300 hover:bg-gray-800 hover:text-white transition-colors font-poppins text-sm mb-2"
          >
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 flex-shrink-0">
          <div className="md:hidden flex items-center gap-2">
            ...
            />
            <span className="text-red-500 text-xs font-poppins font-semibold align-top mt-1">
              ADMIN
            </span>
          </div>
